...
parser = argparse.ArgumentParser(description="Play a trained AC agent.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.num_envs not in (None, 1):
        print(f"[AC] overriding num_envs={args_cli.num_envs} to 1 for single-env play.")
